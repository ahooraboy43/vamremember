...
function getAssetDate(prefix) {
  ...
  // از Intl برای تبدیل مطمئن استفاده می‌کنیم.
  // روش ساده‌تر و مقاوم‌تر:
  const approx =
    new Date(
      year + 621,
      month - 1,
  ...
  // برای ذخیره تاریخ، تاریخ شمسی
  // به صورت متن هم حفظ می‌شود.
  // خود date برای مرتب‌سازی استفاده می‌شود.
  return {
    iso:
      approx.toISOString(),
